...
- Dart sdk: "^3.8.0"
- Flutter: ">=3.32.0"
- Android: `minSdkVersion >= 24`, [AGP](https://developer.android.com/build/releases/gradle-plugin) version `>= 8.11.1` (use [Android Studio - Android Gradle plugin Upgrade Assistant](https://developer.android.com/build/agp-upgrade-assistant) for help)
